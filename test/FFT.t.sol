...
contract FFTTest is Test {
    ...
    function test_finalFFT1() public {
        ...
        real_part.push((int256(1) * 1e18));real_part.push( -1 * 1e18);real_part.push( 0 * 1e18); real_part.push( 0 * 1e18);
        complex_part.push(int256(0) * 1e18); complex_part.push(0 * 1e18);complex_part.push( 1 * 1e18);complex_part.push( -1 * 1e18);
        int256[] memory re;
        int256[] memory im;
    ...
    function test_finalFFT2() public{
        real_part.push(1 * 1e18);real_part.push( -1 * 1e18);real_part.push( 0 * 1e18); real_part.push( 0 * 1e18);
        real_part.push(1* 1e18);real_part.push( 2* 1e18);real_part.push( 3* 1e18);real_part.push( 2* 1e18);
        complex_part.push(0 * 1e18); complex_part.push(0 * 1e18);complex_part.push( 1 * 1e18);complex_part.push( -1 * 1e18);
        complex_part.push(0* 1e18);complex_part.push(1* 1e18);complex_part.push(3* 1e18);complex_part.push(0* 1e18);
